...
import DogCollector from '../../assets/branding/DogCollector.png'
...
export const projects = [
  ...
  },
  {
    ...
    deploymentLink: 'https://the-dogcollector.herokuapp.com/', 
    repositoryLink: 'https://github.com/KnucklesLT/Dog-Collector',
    image: DogCollector,
    description: `
      A Dog Collecting App where you can add dogs, add toys, and add feedings to each dog. 
    `
  }
]